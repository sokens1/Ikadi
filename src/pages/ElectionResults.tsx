          ...
          <div className="flex items-center justify-between">
            ...
            <nav className="hidden md:flex items-center space-x-6">
              ...
              <div className="relative group">
                ...
                <div className="absolute left-0 mt-2 hidden group-hover:block bg-white text-gov-dark rounded shadow-lg border min-w-[240px] z-50">
                  {(results ? [results.election].filter(Boolean) : []).length === 0 && (
                    <div className="px-3 py-2 text-sm text-gov-gray">Aucun résultat disponible</div>
                  )}
                  {/* Liste des autres résultats: invite à revenir à l'accueil pour lister tous */}
                  <button
                    className="block w-full text-left px-3 py-2 hover:bg-slate-100 text-sm"
                    onClick={() => navigate('/')}
                  >
                    Revenir à l'accueil pour tous les résultats
                  </button>
                </div>
              </div>
