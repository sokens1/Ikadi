        ...
        <DialogHeader className="pb-4 sm:pb-6">
          <DialogTitle className="flex items-center gap-2 sm:gap-3">
            ...
            <div className="flex-1 min-w-0">
              <div className="text-base sm:text-lg lg:text-xl font-bold text-gray-900 leading-tight">Sélection des Centres de Vote</div>
              <div className="text-xs sm:text-sm text-gray-600 mt-1">Choisissez les centres de vote pour cette élection</div>
            </div>
          </DialogTitle>
        </DialogHeader>
